        ...
        this.props.slides.map(function (slide, index) {
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'a',
                { className: 'slider__slide-readmore', href: slide.link },                
                'Читать больше'
...
var slides = [{
  city: 'Космос ?',
  country: 'Что такое',
  img: 'http://wallpapers-images.ru/2560x1600/space/wallpapers/space-images-2560x1600-18.jpg',
  link: '1.html'
}, {
  city: 'Факты',
  country: 'Интересные',
  img: 'https://bipbap.ru/wp-content/uploads/2017/04/maxresdefault-2-6.jpg',
  link: '2.html'
}, {
  city: 'загадки',
  country: 'Две тёмные',
  img: 'http://www.klonator.ru/wp-content/uploads/2018/10/bg9-1.jpg',
  link: '3.html'
}, {
  city: 'угроз',
  country: 'топ 5',
  img: 'https://cdn-images-1.medium.com/max/2600/1*Km7W1r_yUxykYdhu5OAhqA.jpeg',
  link: '4.html'
}, {
  city: 'БУДУЩЕЕ',
  country: 'Космос',
  img: 'https://cs7.pikabu.ru/post_img/big/2018/01/08/4/151538527315456247.png',
  link: '5.html'
}];
